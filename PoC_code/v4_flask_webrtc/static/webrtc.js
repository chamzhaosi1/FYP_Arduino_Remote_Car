...
// console.log(userNameString.split(':'))

let dev_mac_len = userNameString.split(':').length

if (dev_mac_len >=6) {
    userNameStrig = userNameString.replace(/:/g, "_");
...
function login(userName, target_macAdd) {
    myName = userName;
    userToCall = target_macAdd;
