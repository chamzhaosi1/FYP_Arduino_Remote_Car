...
#define ENCA_BR 10 // YELLOW
#define ENCB_BR 11 // GREEN
#define PWM_BR 6
...
//   attachInterrupt(digitalPinToInterrupt(ENCB_BR),readEncoderBBR_wrapper, CHANGE);
	...
	attachPinChangeInterrupt(digitalPinToPinChangeInterrupt(ENCA_BR), readEncoderABR_wrapper, CHANGE);
	attachPinChangeInterrupt(digitalPinToPinChangeInterrupt(ENCB_BR), readEncoderBBR_wrapper, CHANGE);
