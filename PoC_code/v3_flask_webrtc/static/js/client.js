...
var dataChannelLog = document.getElementById('data-channel'),
    ...
    remoteVideoSecond = document.getElementById('remoteVideo');
...
function createPeerConnection_internal() {
    ...
    pc.onicecandidate = handleIceCandidate_internal;

    console.log(pc)
    return pc;
}

function handleIceCandidate_internal(event) {
...
function negotiate() {
    return pc.createOffer().then(function(offer) {
        ...
        return $.ajax({
            urls:'https://romo.kynoci.com:8555/offer',
            type: 'POST',
            dataType: 'json', 
        ...
        // return fetch('https://romo.kynoci.com:8555/offer', {
        //     body: JSON.stringify({
        //         sdp: offer.sdp,
        //         type: offer.type,
        //         video_transform: document.getElementById('video-transform').value
...
function start() {
    ...
    pc = createPeerConnection_internal();
    console.log(pc)
    ...
    if (constraints.audio || constraints.video) {
        ...
        console.log(remoteVideoSecond.captureStream())
        console.log(remoteVideoSecond.captureStream().getTracks())
